...
def get_parser(source, target):
    ...
    parser.add_argument('--data_dir', type=str, default='./Skin')
...
def train(source_loader, target_train_loader, target_test_loader, model, optimizer, lr_scheduler, args, name, location):
    ...
    for e in range(1, args.n_epoch + 1):
        ...
        if count == args.n_epoch:
            ...
            print(args.n_iter_per_epoch * args.batch_size)
...
def main(source, target,name, location):
    parser = get_parser(source, target)
...
if __name__ == "__main__":
    main('Train', 'Test', name='AtoW.csv',location='./TSNE/BNN.png')
